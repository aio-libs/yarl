...
- **No "Quality Report" / "Generated by" / "Test summary by
  <agent>" footers in the PR body.** This is the single fastest
  way to get a PR closed in this org. The closed PR at
  `aio-libs/multidict#1336` ended with this exact block, which
  is the shape of footer to never paste:
  ...
  *Generated by <pipeline name> post-mission quality pipeline*
  ...
  No variant of this is acceptable; not a shorter version, not a
  collapsed `<details>` block, not a one-liner that says
  "Generated by <X>". Strip it before opening the PR.
